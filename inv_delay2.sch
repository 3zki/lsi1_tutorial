...
N 460 -170 480 -170 {
lab=pinX}
C {devices/code_shown.sym} 860 -590 0 0 {name=ngspice
only_toplevel=false
...
C {sky130_fd_pr/pfet_01v8.sym} 440 -550 0 0 {name=M9
L=0.15
W=2.2
nf=1
mult=1
...
C {devices/ipin.sym} 110 -170 0 0 {name=p6 lab=inB}
C {sky130_fd_pr/pfet_01v8.sym} 160 -230 0 0 {name=M11
L=0.15
W=4.4
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 160 -110 0 0 {name=M12
L=0.15
W=2
nf=1 
mult=1
...
C {devices/gnd.sym} 730 -40 0 0 {name=l6 lab=GND}
C {devices/gnd.sym} 290 -40 0 0 {name=l7 lab=GND}
C {devices/gnd.sym} 620 -40 0 0 {name=l9 lab=GND}
C {devices/opin.sym} 780 -170 0 0 {name=p14 lab=outX}
C {devices/lab_wire.sym} 360 -170 0 0 {name=p15 sig_type=std_logic lab=pinB}
C {devices/lab_wire.sym} 520 -170 0 0 {name=p16 sig_type=std_logic lab=pinX}
C {devices/gnd.sym} 460 -40 0 0 {name=l10 lab=GND}
C {sky130_fd_pr/pfet_01v8.sym} 710 -230 0 0 {name=M19
L=0.15
W=4.4
nf=1
mult=1
...
C {devices/code.sym} 1130 -140 0 0 {name=TT_MODELS
only_toplevel=true
...
"}
C {sky130_fd_pr/pfet_01v8.sym} 270 -230 0 0 {name=M13
L=0.15
W=4.4
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 440 -230 0 0 {name=M15
L=0.15
W=4.4
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 600 -230 0 0 {name=M17
L=0.15
W=4.4
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 270 -110 0 0 {name=M14
L=0.15
W=2
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 440 -110 0 0 {name=M16
L=0.15
W=2
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 600 -110 0 0 {name=M18
L=0.15
W=2
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 710 -110 0 0 {name=M20
L=0.15
W=2
nf=1 
mult=1
...
C {devices/vdd.sym} 180 -620 0 0 {name=l11 lab=VDD}
C {devices/vdd.sym} 290 -620 0 0 {name=l12 lab=VDD}
C {devices/vdd.sym} 460 -620 0 0 {name=l13 lab=VDD}
C {devices/vdd.sym} 620 -620 0 0 {name=l14 lab=VDD}
C {devices/vdd.sym} 730 -620 0 0 {name=l15 lab=VDD}
C {devices/vdd.sym} 180 -300 0 0 {name=l16 lab=VDD}
C {devices/vdd.sym} 290 -300 0 0 {name=l17 lab=VDD}
C {devices/vdd.sym} 460 -300 0 0 {name=l18 lab=VDD}
C {devices/vdd.sym} 620 -300 0 0 {name=l19 lab=VDD}
C {devices/vdd.sym} 730 -300 0 0 {name=l20 lab=VDD}
